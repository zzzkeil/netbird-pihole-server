...
wget -O  setup_base_no_fw.sh https://raw.githubusercontent.com/zzzkeil/base_setups/refs/heads/master/setup_base_no_fw.sh
chmod +x setup_base_no_fw.sh
...
"1" "Run /root/setup_base_no_fw.sh" \
"2" "Exit" 3>&1 1>&2 2>&3)
